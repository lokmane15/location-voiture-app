            ...
            <div className="container car-details flex justify-center  mt-20 mb-20">
                <div className="card mb-3" style={{width:"30rem"}}>
                    ...
                    <div  className="card-body">
                        ...
                        :(
                        <>
                        <p className="card-text mb-1 font-medium"><MdPriceChange className="size-6 inline mr-3"/> Price by day: {data.prix} DH</p>
                        <p className="card-text mb-1 font-medium"> <FaRoad className="size-6 inline mr-3"/> Mileage: {data.kilomitrage} km</p>
                        <p className="card-text mb-1 font-medium"><IoCalendarClear className="size-6 inline mr-3"/>year: {data.annee}</p>
                        <p className="card-text mb-1 font-medium"> <BsFillFuelPumpFill  className="size-6 inline mr-3"/> fuel type: {data.model && data.model.type_carburant}</p>
                        ...
                        <p className="card-text mb-1 font-medium"> <MdOutlineReduceCapacity className="size-6 inline mr-3" /> Seating capacity: {data.model && data.model.capacite_assises}</p>
                            </>
