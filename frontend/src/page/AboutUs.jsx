  ...
  export default function AboutUs() {
    return (
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        <img
          src="../../public/pexels-tdcat-70912.jpg"
          alt=""
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg font-bold leading-8 text-gray-300">
              Welcome to our car rental service. With over a decade of experience, we offer a wide range of vehicles to meet all your travel needs. Our commitment to quality and customer satisfaction ensures a smooth and enjoyable rental experience.
            </p>
          </div>
