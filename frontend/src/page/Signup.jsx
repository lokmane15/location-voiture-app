  ...
  return (
    <div className="bg-neutral-200">
      <div className="  flex items-center justify-center h-screen mt-10">
        <div className="border border-white rounded shadow-md  text-black bg-white p-10">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="mb-1">
                ...
                <input
                  ...
                  className={`block w-full rounded-md bg-gray-200 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50`}
                />
                {errors.num_cin && (
                  <div className="text-red-500 text-sm">{errors.num_cin}</div>
                )}
              </div>
              <div className="mb-1">
                <label
                ...
                <input
                  ...
                  className={`block w-full rounded-md bg-gray-200 border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 `}
                />
                {errors.nom && (
              ...
              <div className="mb-1">
                ...
                />
                {errors.num_tel && (
                  <div className="text-red-500 text-sm">{errors.num_tel}</div>
                )}
              </div>
              <div className="mb-1 col-span-2">
                ...
                />
                {errors.adresse && (
                  <div className="text-red-500 text-sm">{errors.adresse}</div>
                )}
              </div>
              <div className="mb-1 col-span-2">
                <label
